...
var DynamicEmbed = /** @class */ (function () {
    ...
    */
    DynamicEmbed.prototype.createEmbedFlip = function (message, itemList, emojiList, createEmbed, collectorFunc, collectorParams) {
        return __awaiter(this, void 0, void 0, function () {
            var page, embed, embedMessage, _i, emojiList_1, emoji, filter, collector;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 2];
                    case 5:
                        filter = function (reaction, user) { return emojiList.includes(reaction.emoji.name) && !user.bot; };
                        ...
                        collector.on("remove", function (r) {
                            page = updateEmbed(r, page, itemList, embedMessage, createEmbed, collector, collectorFunc, collectorParams);
                        });
                        return [2 /*return*/];
                }
