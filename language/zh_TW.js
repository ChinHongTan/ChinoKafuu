...
module.exports = {
    ...
    "buy":"從商店中買東西",
    "noItem":"❌ | 這東西不存在",
    "notEnoughMoney":"❌ | 你目前有 ${currency.getBalance(message.author.id)}, 但是 ${item.name} 要價 ${item.cost}!",
    "noMoney":"❌ | 你不夠錢買 ${item.name}，它要價 ${item.cost}!",
    "buySucess":"✅ | 你購買了: ${item.name}.",
    "inventory":"查看你的物品",
    "noInventory":"❌ | ${target.tag} 什麽也沒有!",
    "showInventory":"${target.tag} 目前有 ${items.map((i) => `${i.amount} ${i.item.name}`).join(', ')}",
    "leaderboard":"查看金錢排行榜",
    "shop":"查看商店物品",
    "transfer":"給其他人送錢",
    "invalidAmount":"❌ | 很抱歉 ${message.author}, 這個數額不正確",
    "noTransferTarget":"❌ | 請說清楚你要給誰錢!",
    "noMoenyTransfer":"❌ | 很抱歉 ${message.author}, 你只有 ${currentAmount}.",
    "negativeAmount":"❌ | 請輸入大於零的數字, ${message.author}.",
    "transferSucess":"✅ | 成功把 ${transferAmount}💰 給了 ${transferTarget.tag}. 你現在有 ${currency.getBalance(message.author.id)}💰",
    "8ball":"問問神奇八號球~",
    "reply1":"這是必然",
    "reply2":"肯定是的",
    "reply3":"不用懷疑",
    ...
    "loli":"蘿莉圖",
    "loliPic":"蘿莉!",
    "loliProvider":"來源商：${images.author}\n[圖片鏈接](${messageurl})",
    "youtube":"一起看YouTube!",
    "notInVC":"❌ | 加入語音頻道後才能使用此指令！",
    "anime":"根據動漫截圖查找動漫/查詢動漫相關信息",
