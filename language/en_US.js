...
module.exports = {
    ...
    "load":"Load a server backup based on backup ID.",
    ...
    "userBalance":"${target.tag} has ${currency.getBalance(target.id)}💰",
    "buy":"Buy an item from the shop.",
    "noItem":"❌ | That item doesn't exist.",
    "notEnoughMoney":"❌ | You currently have ${currency.getBalance(message.author.id)}, but the ${item.name} costs ${item.cost}!",
    "noMoney":"❌ | You don't have enough money to buy ${item.name} which costs ${item.cost}!",
    "buySucess":"✅ | You've bought: ${item.name}.",
    "inventory":"Show your inventory.",
    "noInventory":"❌ | ${target.tag} has nothing!",
    "showInventory":"${target.tag} currently has ${items.map((i) => `${i.amount} ${i.item.name}`).join(', ')}",
    "leaderboard":"Show the leaderboard.",
    "shop":"Show the shop items",
    "transfer":"Transfer money to a user",
    "invalidAmount":"❌ | Sorry ${message.author}, that's an invalid amount.",
    "noTransferTarget":"❌ | Please specify a person to transfer your money!",
    "noMoenyTransfer":"❌ | Sorry ${message.author}, you only have ${currentAmount}.",
    "negativeAmount":"❌ | Please enter an amount greater than zero, ${message.author}.",
    "transferSucess":"✅ | Successfully transferred ${transferAmount}💰 to ${transferTarget.tag}. Your current balance is ${currency.getBalance(message.author.id)}💰",
    "8ball":"Ask the 8ball your question!",
    ...
    "covid":"Latest global/country covid status!",
    ...
    "sauce":"Search SauceNao for an image source.",
    ...
    "loop-queue":"Loop the currently played queue!",
    "loop":"Loop the currently played song!",
    "lyric":"Search for lyrics!",
    "nowplaying":"Sees the song currently being played.",
    "npTitle":"**Now playing ♪**",
    "requester":"Requested by:",
    "musicFooter":"音樂系統",
    "noSong":"❌ | There is no song in the queue!",
    "pause":"Pause!",
    "play":"Play a song based on a given url or a keyword",
